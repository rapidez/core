...
<toggler v-slot="{ isOpen, toggle, close }">
    <div>
        ...
        <div class="fixed inset-0 overflow-hidden {{ config('rapidez.frontend.z-indexes.slideover') }} {{ $mobileOnly ? 'md:static md:block' : '' }}" :class="isOpen ? 'pointer-events-auto' : 'pointer-events-none'">
