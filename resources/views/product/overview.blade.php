...
@section('content')
            ...
            <div class="relative flex flex-col gap-8 sm:flex-row">
                ...
                <div class="flex flex-col gap-5 sm:w-1/2">
                    ...
                    <div>
                        ...
                        <dl class="flex flex-col text-inactive [&>dd]:rounded [&>dd]:p-2 odd:[&>dd]:bg-base odd:[&>dd]:font-semibold odd:[&>dd]:text-neutral even:[&>dd]:pl-4">
                            <dd>ID</dd>
    ...
    @if (App::providerIsLoaded('Rapidez\Reviews\ReviewsServiceProvider'))
        <div class="my-5 py-8 bg-base min-h-[515px]">
