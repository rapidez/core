    ...
    <template slot-scope="{ order, hideBilling, shipping, billing, items }">
        <div dusk="checkout-success" v-cloak v-if="order">
            ...
            <div class="flex flex-col mt-4 gap-x-4 md:flex-row">
                <div class="w-full p-8 bg-base rounded border-l-2 border-neutral md:w-1/2" v-if="billing">
                ...
                <div class="w-full p-8 bg-base rounded border-l-2 border-neutral mt-4 md:mt-0 md:w-1/2" v-if="shipping">
            ...
            <div class="flex flex-col mt-4 gap-x-4 md:flex-row">
                <div class="w-full p-8 bg-base rounded border-l-2 border-neutral md:w-1/2">
                    <p class="text-neutral font-lg font-bold mb-2">@lang('Shipping method')</p>
                    <p>@{{ order.shipping_description }}</p>
                </div>
                <div class="w-full p-8 bg-base rounded border-l-2 border-neutral mt-4 md:mt-0 md:w-1/2">
