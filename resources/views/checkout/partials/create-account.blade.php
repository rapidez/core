<div v-if="!user" id="create-account-wrapper">
    <div class="grid grid-cols-12 gap-4 mb-3">
        ...
        <div class="col-span-12 sm:col-span-6" v-if="checkout.create_account || checkout.hasVirtualItems">
            <x-rapidez::input label="Password" name="password" type="password" v-model="checkout.password" required />
        </div>
        <div class="col-span-12 sm:col-span-6" v-if="checkout.create_account || checkout.hasVirtualItems">
            <x-rapidez::input name="password_repeat" type="password" v-model="checkout.password_repeat" label="Repeat password" required />
        </div>
    </div>
</div>
