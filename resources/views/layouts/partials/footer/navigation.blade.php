<nav class="flex flex-wrap md:flex-nowrap justify-between w-full md:gap-8 [&>ul]:w-1/2 [&>ul]:md:w-1/4 [&>ul]:mt-4 [&>ul]:md:mt-0 [&>ul]:space-y-4 [&>ul>li]:text-base [&>ul>li]:text-gray-500 hover:[&>ul>li]:text-gray-900 [&>ul>p]:text-base [&>ul>p]:font-medium [&>ul>p]:text-gray-900">
    <ul>
        <p>Catalog</p>
