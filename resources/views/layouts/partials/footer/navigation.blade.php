<nav class="grid w-full justify-between gap-x-4 gap-y-8 hover:prose-a:text-gray-900 prose-ul:space-y-3 prose-li:text-base prose-li:text-gray-500 sm:grid-cols-2 md:grid-cols-4">
    <ul>
