...
>
    ...
    >
        ...
        >
            <ul class="absolute left-2/3 right-auto bg-white border shadow-xl rounded-b-lg lg:rounded-t-lg w-screen sm:w-full lg:w-[960px] xl:ml-0 sm:left-1/2 transform -translate-x-1/2 xl:rounded-t-lg mt-px flex flex-wrap {{ config('rapidez.z-indexes.autocomplete') }}" v-if="isOpen && suggestions.length">
                <li
