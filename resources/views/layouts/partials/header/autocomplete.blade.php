...
<autocomplete v-if="$root.loadAutocomplete" v-cloak>
    <x-rapidez::reactive-base>
        ...
        >
            ...
            >
                <ul
                    class="{{ config('rapidez.z-indexes.header-dropdowns') }} absolute -inset-x-10 top-full grid max-h-[600px] gap-5 overflow-auto rounded-b-xl border bg-white p-2 md:p-5 shadow-xl md:inset-x-0 md:w-full md:-translate-y-px md:grid-cols-2"
