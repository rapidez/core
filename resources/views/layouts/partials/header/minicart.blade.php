<cart v-cloak>
    <div class="cursor-pointer" v-if="hasItems" v-click-outside="close" @click="toggleCart" slot-scope="{ cart, hasItems, toggle, close, toggleCart }">
        <div class="flex my-1">
        ...
        <div v-if="toggle" class="absolute right-0 bg-white border shadow rounded p-3 mr-1 z-10">
            <table class="mb-3">
