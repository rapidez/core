<header class="relative mb-5 max-md:pb-4 border-b z-header">
    <div class="container flex flex-wrap items-center max-sm:px-3">
        ...
        <nav class="inset-x-0 top-full w-full bg-white max-md:absolute max-md:grid max-md:grid-rows-[0fr] max-md:shadow-sm max-md:transition-all max-md:peer-checked:grid-rows-[1fr]">
