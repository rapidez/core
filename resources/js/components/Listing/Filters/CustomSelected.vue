...
export default {
    ...
    computed: {
        activeFilters() {
            return Object.keys(this.selectedValues).filter((filterKey) => {
                return this.selectedValues[filterKey].showFilter && (Array.isArray(this.selectedValues[filterKey].value) ? this.selectedValues[filterKey].value.length : !!this.selectedValues[filterKey].value)
            }).flatMap((filterKey) => {
                let result;

                if (Array.isArray(this.selectedValues[filterKey].value) && 
