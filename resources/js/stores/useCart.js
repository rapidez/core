...
export const checkAvailability = function (cartItem) {
    ...
    // should be fixed in the next Magento release (https://github.com/magento/magento2/blame/2.4-develop/app/code/Magento/QuoteGraphQl/Model/CartItem/ProductStock.php#L61).
