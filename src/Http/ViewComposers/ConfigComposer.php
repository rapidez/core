...
class ConfigComposer
{
    ...
    public function getTaxConfiguration()
    {
        return [
            'calculation' => [
                'price_includes_tax' => Rapidez::config('tax/calculation/price_includes_tax', 0),
                'base_subtotal_should_include_tax' => Rapidez::config('tax/calculation/base_subtotal_should_include_tax', 1),
                'algorithm' => Rapidez::config('tax/calculation/algorithm', 'TOTAL_BASE_CALCULATION'),
                'apply_after_discount' => Rapidez::config('tax/calculation/apply_after_discount', 1),
                'apply_tax_on' => Rapidez::config('tax/calculation/apply_tax_on', 0),
                'based_on' => Rapidez::config('tax/calculation/based_on', 'shipping'),
                'cross_border_trade_enabled' => Rapidez::config('tax/calculation/cross_border_trade_enabled', 0),
                'discount_tax' => Rapidez::config('tax/calculation/discount_tax', 0),
                'shipping_includes_tax' => Rapidez::config('tax/calculation/shipping_includes_tax', 0)
            ],
            'display' => [
