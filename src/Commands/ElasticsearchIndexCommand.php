...
abstract class ElasticsearchIndexCommand extends Command
{
    ...
    public function indexStore(Store $store, string $indexName, callable|iterable $items, callable|array $mapping, callable|string $id = 'id'): void
    {
    ...
    public function prepareIndexerWithStore(Store $store, string $indexName, array $mapping = [], array $settings = []): void
    {
